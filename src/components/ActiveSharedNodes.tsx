...
const SharedNodeCard = ({ node }: { node: SharedNode }) => {
    return (
        <div className="w-full p-[1px] bg-gradient-to-l from-[#00AEB9] to-[#EC008C] rounded-[76px]">
            {/* Desktop View */}
            <div className="hidden sm:flex w-full flex-row justify-between items-center gap-[20px] bg-[#1C1840] rounded-[76px] px-[40px] xl:px-[95px] py-[10px]">
            ...
            {/* Mobile View */}
            <div className="sm:hidden w-full flex flex-col bg-[#1C1840] rounded-[76px] px-[60px] py-[15px] gap-[10px]">
                <div className="flex flex-row justify-between items-center">
                    <div className="text-[16px] text-white font-family-sora font-regular">#{node.id}</div>
                    <div className="text-[16px] text-white font-family-sora font-regular">Ends In: {node.endsIn}</div>
                </div>
                <div className="flex flex-col gap-[5px]">
                    <div className="text-[16px] text-white font-family-sora font-regular">IP: {node.ip}</div>
                    <div className="text-[16px] text-white font-family-sora font-regular">Pose Score: {node.poseScore}</div>
                </div>
            </div>
        </div>
    );
...
export default function ActiveSharedNodes() {
    return (
        <main className="pt-6 pb-[230px] px-[15px] sm:px-0">

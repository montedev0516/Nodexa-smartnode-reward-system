  ...
  return (
    <section className="pt-16">
      ...
      <div className="flex justify-center py-5 px-5 space-x-8">
        ...
        <div className="inline-block w-[90px] h-[90px] p-[2px] bg-gradient-to-t from-[20%] from-[#00AEB9] via-[50%] via-[#6e5da4] to-[80%] to-[#ec008c] rounded-full">
        ...
        <div className="inline-block w-[90px] h-[90px] p-[2px] bg-gradient-to-b from-[20%] from-[#00AEB9] via-[50%] via-[#6e5da4] to-[80%] to-[#ec008c] rounded-full">
           <button className="w-full h-full flex justify-center items-center bg-[#272E50] rounded-full cursor-pointer">

        ...
        <div className="w-[300px] sm:w-[527px] py-[100px]">
          <form className="space-y-6">
            ...
            <div className="flex justify-center items-center pt-[20px]">
              <button
                type="submit"
                className="w-[300px] h-[50px] bg-gradient-to-b from-[#F091C9] to-[#EC008C] font-family-sora text-[25px] text-white py-3 rounded-[45px] transition-colors text-center flex justify-center items-center cursor-pointer"
              >
                Reset Password
              </button>
            </div>
